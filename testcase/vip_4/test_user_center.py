...
class UserPageTest(BaseCase):
    ...
    def test_user_info(self):
        ...
        self.assertEqual(user_name, Base.get_vip_info(4)['mobile'])
    ...
    def test_my_set_info(self):
        ...
        try:
            self.assertEqual(nick_name, Base.get_vip_info(4)['mobile'])
            self.assertEqual(mobil, Base.get_vip_info(4)['mobile'])
